...
@Component({
  selector: 'app-ece2',
  templateUrl: './ece2.page.html',
  styleUrls: ['./ece2.page.scss'],
})
export class Ece2Page implements OnInit {

  constructor(private foo : FileOpener , private ts : ToastController , private transfer : FileTransfer , private file : File) { }
